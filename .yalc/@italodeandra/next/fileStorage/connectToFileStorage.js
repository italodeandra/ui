 ...
 */
// @ts-ignore
var cached = global.minio;
if (!cached) {
    // @ts-ignore
    cached = global.minio = { conn: null };
}
function connectToFileStorage() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, cached.conn.bucketExists(process.env.S3_BUCKET_NAME)];
                case 1:
                    if (!!(_a.sent())) return [3 /*break*/, 3];
                    return [4 /*yield*/, cached.conn.makeBucket(process.env.S3_BUCKET_NAME, process.env.S3_REGION)];
                case 2:
                    _a.sent();
                    _a.label = 3;
                case 3: return [2 /*return*/, cached.conn];
            }
        });
    });
}
