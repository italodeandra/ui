...
export default function Header({
  ...
  return (
    <header
      ...
      {...props}
      className={clsx(
        "fixed top-0 z-20 flex h-16 w-full items-center px-2.5 shadow-none shadow-slate-900/5 ring-offset-gray-100 transition-colors duration-500 scrolled:shadow-md sm:px-4 md:px-6",
